...
git clone https://github.com/BananaDroid-exynos9820/android_vendor_samsung_d1 vendor/samsung/d1
...
git clone https://github.com/BananaDroid-exynos9820/android_hardware_samsung hardware/samsung
